...
public class FFTank extends OpMode {
	...
	public void init() {
		...
		handPosition = 0.5;
		// assign the starting position of the tape measure
		tapeposition = 0.5;
	}
	...
	public void loop() {
		...
		// Manage Tape Servo Motor
		// if X button it pressed increase tape position
		// if B button is pressed decrease tape position
		if (gamepad1.x)
		{
			tapeposition  = tape.getPosition() + tapedelta;
		}
		else if (gamepad1.b)
		{
			tapeposition = tape.getPosition() - tapedelta;
